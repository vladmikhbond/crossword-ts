...
export const data: {[key: string]: Topic} = 
{
    ...
    'Всемирка (рус)': {rIgno: true, auto: 5, terms: 
    `Ачебе - И пришло разрушение (Чинуа …)
    Бальзак - Отец Горио
    Беккет - Моллой (Сэмюэл …)
    Боккаччо - Декамерон (Джованни …)
    Борхес - Вымыслы (Хорхе Луис …)
    Бронте - Грозовой перевал (Эмили …)
    Вальмики - Рамаяна
    Вергилий - Энеида
    Вулф - Миссис Дэллоуэй (Вирджиния …)
    Вьяса - Махабхарата
    Гамсун - Голод (Кнут …)
    Гете - Фауст
    Гоголь - Мёртвые души (Николай …)
    Гомер - Илиада
    Грасс - Жестяной барабан (Гюнтер …)
    Данте - Божественная комедия
    Дёблин - Берлин Александрплац (Альфред …)
    Джойс - Улисс (Джеймс …)
    Дидро - Жак-фаталист и его хозяин (Дени …)
    Диккенс - Большие надежды (Чарльз …)
    Достоевский - Бесы
    Еврипид - Медея
    Звево - Самопознание Дзено (Итало …)
    Ибсен - Кукольный дом (Генрик …)
    Кавабата - Стон горы (Ясунари …)
    Казандзакис - Невероятные похождения Алексиса Зорбаса (Никос …)
    Калидаса - Шакунтала
    Камю - Посторонний (Альбер …)
    Кафка - Замок (Франц …)
    Конрад - Ностромо (Джозеф …)
    Лакснесс - Самостоятельные люди (Халлдор …)
    Лессинг - Золотая тетрадь (Дорис …)
    Линдгрен - Пеппи Длинныйчулок (Астрид …)
    Лорка - Цыганское романсеро (Федерико Гарсиа …)
    Лоуренс - Сыновья и любовники (Дэвид …)
    Манн - Будденброки (Томас …)
    Маркес - Сто лет одиночества
    Махфуз - История нашей улицы  (Нагиб …)
    Мелвилл - Моби Дик (Герман ... )
    Монтень - Опыты (Мишель де …)
    Моранте - История (Эльза …)
    Моррисон - Возлюбленная (Тони …)
    Музиль - Человек без свойств (Роберт …)
    Набоков - Лолита
    Овидий - Метаморфозы
    Оруэлл  - 1984 (Джордж …)
    Остин - Гордость и предубеждение (Джейн …)
    Пессоа - Книга непокоя (Фернанду …)
    Пруст - В поисках утраченного времени (Марсель …)
    Рабле - Гаргантюа и Пантагрюэль (Франсуа …)
    Роза - Тропы по большому сертану (Жуан Гимарайнс …)
    Рульфо - Педро Парамо (Хуан …)
    Руми - Маснави (Джалаладдин …)
    Рушди - Дети полуночи (Салман …)
    Саади - Бустан
    Салих - Сезон паломничества на Север (Тайиб …)
    Сарамаго - Слепота (Жозе …)
    Свифт - Путешествия Гулливера (Джонатан …)
    Селин - Путешествие на край ночи (Луи-Фердинанд …)
    Сервантес - Хитроумный идальго Дон Кихот Ламанчский
    Сикибу - Повесть о блистательном принце Гэндзи (Мурасаки ...)
    Синь - Записки сумасшедшего (Лу…  китайск.)
    Софокл - Эдип-царь
    Стендаль - Красное и чёрное
    Стерн - Жизнь и мнения Тристрама Шенди, джентльмена  (Лоренс …)
    Твен - Приключения Гекльберри Финна
    Толстой - Смерть Ивана Ильича
    Уитмен - Листья травы (Уолт …)
    Флобер - Госпожа Бовари
    Фолкнер - Шум и ярость (Уильям …)
    Хемингуэй - Старик и море
    Чехов - Палата № 6
    Чосер - Кентерберийские рассказы (Джеффри …)
    Шекспир - Отелло
    Элиот - Мидлмарч (Джордж …)
    Эллисон - Человек-невидимка (Ральф …)
    Юрсенар - Воспоминания Адриана  (Маргерит …)`
}};
